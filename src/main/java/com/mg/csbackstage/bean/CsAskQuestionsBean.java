 ...
 * 客服问题列表
 */
@EntityTable(tableName = "t_cs_ask_questions", primaryKey = "id")
@Component
public final class CsAskQuestionsBean extends DataBase implements IDataSource,Serializable
{
    /**
     * 唯一id
     */
    ...
    public final SqlProcessor<CsAskQuestionsBean> SP() {
        return SqlProcessor.getInstance(CsAskQuestionsBean.class);
    }
    ...
    public final SqlOnlyReadProcessor<CsAskQuestionsBean> SPRead() {
        return SqlOnlyReadProcessor.getInstance(CsAskQuestionsBean.class);
    }

} // end class CsAskQuestionsBean
